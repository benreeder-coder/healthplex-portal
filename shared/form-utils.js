...
const FormUtils = {
  ...
  buildIntakeWizardPayload(payload, data) {
    ...
    // ===== PDF URL =====
    // Pick up the Vercel Blob URL generated by wizard.js handleSubmit
    payload.pdfUrl = window._intakeWizardPDFUrl || null;
    payload.pdfFailed = !!window._intakeWizardPDFFailed;
    // Clear after use
    delete window._intakeWizardPDFUrl;
  },
